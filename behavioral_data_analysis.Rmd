...
```{r message=TRUE, warning=TRUE}
model.accrt.t<-lmerTest::lmer(log10(AccRT/1000)~scaledAge + gender + catPunLevel * catRewLevel * catCong + scaledTrialNum + scaledGlobalIntervalNum + (1 + catPunLevel * catRewLevel * catCong + scaledTrialNum + scaledGlobalIntervalNum|mTurkID),data=df.trial.combined.acc)
...
```{r}
model.acc.t<-glmer(Acc ~ scaledAge + gender + catPunLevel * catRewLevel * catCong + scaledTrialNum + scaledGlobalIntervalNum + (1 + catPunLevel * catRewLevel * catCong + scaledTrialNum + scaledGlobalIntervalNum|mTurkID),family=binomial,data=df.trial.combined)
summary(model.acc.t)
